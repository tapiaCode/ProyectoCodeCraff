using ProyectoCodeCraff.Reportes;
...
namespace ProyectoCodeCraff
{
    public partial class FrmCrearUsuario : Form
    {
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            usuario.clave_acceso = CalcularHashSHA256(this.TxtContraseña.Text);
        ...
        {
            Utilitarios.TipodeReporte = 3;
            FrmReportes objFrmReportes = new FrmReportes();
            objFrmReportes.Show();
        }
